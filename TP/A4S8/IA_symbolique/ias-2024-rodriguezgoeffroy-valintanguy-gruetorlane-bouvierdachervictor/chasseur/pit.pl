% ce fichier est le meme à une difference près de wumpus.pl
...
% recupere les positions où il y a possiblement des pit et indubitablement où il y n'y a pas de pit 
...
% recreer les nouvelles cases où le pit est ou n'est pas
...
% si dans les cases adjacentes il y a un pit
...
% meme chose que true pit mais dans le cas où les cases adjacente ne contiene pas de wumpus
...
% met à jour les cases où se trouve le pit
